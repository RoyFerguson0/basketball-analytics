...
class PassInterceptionDrawer:
    ...
    def draw_frame(self, frame, frame_num, passes, interceptions):
        ...
        # Get stats till the current frame
        ...
        cv2.putText(
            img=frame,
            text=f"Team 1 - Passes: {team1_passes} Interceptions: {team1_interceptions}",
            org=(text_x, text_y1),
        ...
        cv2.putText(
            img=frame,
            text=f"Team 2 - Passes: {team2_passes} Interceptions: {team2_interceptions}",
            org=(text_x, text_y2),
            fontFace=cv2.FONT_HERSHEY_SIMPLEX,
            fontScale=font_scale,
            color=(255, 0, 0),
    ...
    def draw(self, video_frames, passes, interceptions):
        ...
        for frame_num, frame in enumerate(video_frames):
            ...
            frame_drawn = self.draw_frame(
                frame, frame_num, passes, interceptions)
